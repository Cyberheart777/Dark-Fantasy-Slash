...
export const META_UPGRADES: MetaUpgradeDef[] = [
  ...
  },
  {
    ...
    modifiers: (rank) => flatModifiers({ dodgeChance: 0.03 * rank }, `meta:ghost_step:${rank}`),
    statLine: (r) => `+${3 * r}% Dodge Chance`,
  },
  ...
  // ── Sustain ──
  {
    ...
    icon: "🩸",
    description: "+1% lifesteal per rank.",
    maxRanks: 3,
    costs: [200, 500, 1000],
    modifiers: (rank) => flatModifiers({ lifesteal: 0.01 * rank }, `meta:blood_pact:${rank}`),
    statLine: (r) => `+${r}% Lifesteal`,
  },
  {
    id: "troll_marrow",
    name: "Troll Marrow",
  ...
  },
  {
    ...
    icon: "👻",
    description: "+1 HP on kill per rank.",
    maxRanks: 4,
    costs: [130, 280, 460, 680],
    modifiers: (rank) => flatModifiers({ onKillHeal: 1 * rank }, `meta:soul_siphon:${rank}`),
    statLine: (r) => `+${r} HP on Kill`,
  },
  ...
  },
  {
    ...
    icon: "⚡",
    description: "-0.06s dash cooldown per rank.",
    maxRanks: 4,
    costs: [130, 260, 420, 620],
    modifiers: (rank) => flatModifiers({ dashCooldown: -0.06 * rank }, `meta:dark_resilience:${rank}`),
    statLine: (r) => `-${(0.06 * r).toFixed(2)}s Dash CD`,
  },
  {
    id: "battle_instinct",
  ...
  },
  {
    ...
    icon: "📖",
    description: "+6% XP gain per rank.",
    maxRanks: 5,
    costs: [100, 220, 380, 580, 820],
