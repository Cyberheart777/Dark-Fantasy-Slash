...
export const META_UPGRADES: MetaUpgradeDef[] = [
  ...
  },
  {
    ...
    icon: "🌪",
    description: "+0.04 attack speed per rank.",
    maxRanks: 5,
    costs: [150, 300, 480, 700, 950],
    modifiers: (rank) => flatModifiers({ attackSpeed: 0.04 * rank }, `meta:swift_strikes:${rank}`),
    statLine: (r) => `+${(0.04 * r).toFixed(2)} Attack Speed`,
  },
  {
    id: "reapers_eye",
    name: "Reaper's Eye",
